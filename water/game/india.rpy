...
label question_loop:
  menu:
    "How do monsoons work?":
      s normal "During summer months when the Asian landmass heats up, warm, moist air flows northward from the Indian Ocean towards the Himalayas."
      s "This brings abundant showers and thundershowers to India."
      jump question_loop

    "Why is India so dependent on monsoons?":
      s normal "Monsoon rains provide important reservoirs of water that sustain human activities like agriculture and supports the natural environment through replenishment of aquifers."
      jump question_loop
